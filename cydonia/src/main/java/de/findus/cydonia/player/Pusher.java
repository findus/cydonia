...
public class Pusher extends AbstractEquipment {
	 ...
	 */
	public Pusher(String name, float force, long interval, Player player, MainController mainController) {
	...
	private void initHUDImgs() {
		try {
			if(hudImg == null) {
				hudImg = ImageIO.read(this.getClass().getResourceAsStream("/de/findus/cydonia/gui/hud/pusher.png"));
			}
		} catch (IOException e) {
		}
	}
