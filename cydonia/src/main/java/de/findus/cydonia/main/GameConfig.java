...
public class GameConfig {
     ...
     * set on this GameConfig.
     *  
     * @param other The GameConfig to copy the settings from
     */
    ...
    /**
     * Same as {@link #copyFrom(de.findus.cydonia.main.GameConfig) }, except
     * doesn't overwrite settings that are already set.
     * 
     * @param other  The GameConfig to merge the settings from
     */
